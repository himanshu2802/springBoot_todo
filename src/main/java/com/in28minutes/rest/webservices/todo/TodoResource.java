...
public class TodoResource {
	...
	public ResponseEntity<Todo> updateTodo(@PathVariable String userName, @PathVariable String todoId, @RequestBody Todo todo) {
		Todo upadtedTodo = todoService.save(todo);
		return new ResponseEntity<Todo>(upadtedTodo, HttpStatus.OK);
	}
